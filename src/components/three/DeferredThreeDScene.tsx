...
export default function DeferredThreeDScene({ mode, fallbackSrc }: { mode: ThreeDMode; fallbackSrc: string }) {
  ...
  const showStaticFallback =
    mode === "OFF" || reducedMotion || tier === null || contextLost || !shouldMount;
  ...
  return (
    <div ref={containerRef} className="w-full h-full pointer-events-none" aria-hidden="true" role="presentation">
