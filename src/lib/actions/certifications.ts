...
const CertificationSchema = z.object({
  ...
  credentialId: z.preprocess((val) => (val === "" || val === undefined ? null : val), z.string().nullable().optional()),
  issueDate: z.coerce.date(),
  expirationDate: z.preprocess((val) => (val === "" || val === undefined ? null : val), z.coerce.date().nullable().optional()),
  verificationUrl: z.preprocess((val) => (val === "" || val === undefined ? null : val), z.string().url().nullable().optional()),
  imageMediaId: z.preprocess((val) => (val === "" || val === undefined ? null : val), z.string().nullable().optional()),
