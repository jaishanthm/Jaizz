...
async function main() {
  ...
  const socialLinksData = [
    ...
    { id: "social-tryhackme", platform: "TryHackMe", url: "https://tryhackme.com/p/jaishanth", iconKey: "tryhackme", customLabel: "TryHackMe Top 5%", order: 3 },
  ...
  await prisma.education.upsert({
    ...
    update: {
      ...
      description: "Rigorous academic study in core computing systems, network security architectures, applied cryptography, operating systems internals, and hands-on laboratory security assessments alongside self-directed offensive security research.",
  ...
  await prisma.achievement.upsert({
    ...
    update: {
      title: "TryHackMe Top 5% Ranked Security Researcher",
      category: "RANKING",
      description: "Achieved Top 5% ranking on TryHackMe (Global Rank #110,438) with 101 completed rooms, Level 9 [MAGE], 14 badges, and an 86-day research streak.",
  ...
  const pageSEOEntries = [
    ...
    { path: "/achievements", seoTitle: "Achievements & Milestones — Jaishanth M", seoDescription: "TryHackMe Top 5% ranking, Bugcrowd security research recognition, and laboratory milestones." },
